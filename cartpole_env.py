...
class CartPoleEnv:
    ...
    **Note:** While the ranges above denote the possible values for observation space of each element,
    ...
    def __init__(self, render_mode: Optional[str] = None):
        ...
        self.observation_space = np.array([-high, high]).T
    ...
    def step(self, action):
        ...
        return torch.tensor(self.state, dtype=torch.float32), reward, terminated, {}
    ...
    def reset(
        ...
        self.steps_beyond_terminated = None
        self.steps_taken = 0
        return torch.tensor(self.state, dtype=torch.float32), 0, False, {}
